...
module "eks" {
  ...
  aws_auth_roles = [
    {
      rolearn  = "arn:aws:iam::123456789012:role/luxe-codebuild-role"
      username = "codebuild"
      groups   = ["system:masters"]
    },
    {
      rolearn  = "arn:aws:iam::123456789012:role/luxe-github-runner-role"
      username = "github-runner"
      groups   = ["system:masters"]
    },
    {
      rolearn  = "arn:aws:iam::123456789012:user/project-admin"
      username = "admin"
      groups   = ["system:masters"]
    }
  ]
